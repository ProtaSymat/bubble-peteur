...
window.onload = function() {
    ...
    function init() {
        // Load images
        images = loadImages(["bubble-peteurs.png"]);
    ...
    function main(tframe) {
        ...
        if (!initialized) {
            ...
            var loadtext = "Chargement " + loadcount + "/" + loadtotal + " des péteurs";
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
            ...
            context.fillStyle = "#ffffff";
            context.font = "24px Verdana";
            drawCenterText("Perdu péteur!", level.x, level.y + level.height / 2 + 10, level.width);
            drawCenterText("Jouer", level.x, level.y + level.height / 2 + 40, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Bubble péteur", 10, 37);
